...
Currently co-founding [R0GUE](https://r0gue.io) — building smart contract runtime infrastructure
and confidential compute protocols in Rust.

Previously at [Parity Technologies](https://parity.io), writing production Rust on a large
open-source distributed systems codebase.

Embedded work: bare-metal Rust on STM32 (ARM Cortex-M3) — interrupt-driven UART with multithreaded ring buffers,
